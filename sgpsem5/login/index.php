...
if (isset($_POST["signup"])) {
  ...
  if ($password !== $cpassword) {
    ...
    $sql = "INSERT INTO users (full_name, email, mobile, password, token, status) VALUES ('$full_name', '$email', '$mobile' ,'$password', '$token', '0')";
...
if (isset($_POST["signin"])) {
  ...
  if (mysqli_num_rows($check_email) > 0) {
    ...
    header("Location: http://localhost/sgpsem5/login/home.php");
  } else {
    ...
    <div class="forms-container">
      <div class="signin-signup">
        ...
        <form action="" class="sign-up-form" method="post">
          ...
          <div class="input-field">
            <i class="fas fa-envelope"></i>
            <input type="text" placeholder="Enter mobile" name="signup_mobile" value="<?php echo $_POST["signup_mobile"]; ?>" required />
          </div>
          <div class="input-field">
            <i class="fas fa-lock"></i>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <br>
          <br>
          <h3>WELCOME TO ALL IN ONE ~ make your work easy!</h3>
          <p>
      ...
      <div class="panel right-panel">
        <div class="content">
          ...
          <p>
            Promise to provide easy and better service platform and satisfy your need.
          </p>
